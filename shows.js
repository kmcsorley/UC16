...
function displayCast(data){
    ...
    if(cast[0].person.name === "none") {
        ...
        for(i = 0; i < cast.length; i++){
            display = display + "<tr><td>"+getImage(cast[i].person.image.medium)+"</td><td>"+cast[i].person.name+"</td><td>"+cast[i].character.name+"</td></tr>";
        }
        display = display + "</table>";
        /*
        for(i = 0; i < cast.length; i++){
            display = display + getImage(cast[i].person.image.medium) + "Actor: " + cast[i].person.name + "       Character: " + cast[i].character.name + "<hr>";
        }
        */

        //style images after they are created
        ...
        //style table rows after they are created
        ...
        for(i = 0; i < header.length; i++){
            ...
            header[i].style.backgroundColor = "lightgrey";
